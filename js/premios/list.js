                ...
                switch(campo.key){
                    ...
                    case 'actions':
                        ...
                        <div class="d-flex justify-content-end">
                            <button data-action="delete" data-id="${row.idAward}" class="btn btn-danger d-flex justify-content-between align-items-center me-2">
                            ...
                            <a href="${baseAdminUrl}${pageSlug}/editar/${row.idAward}" class="btn btn-secondary d-flex justify-content-between align-items-center me-2">
