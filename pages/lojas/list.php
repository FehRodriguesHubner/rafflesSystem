...
<body>
        ...
        <section class="wrapper-contents">
            ...
            <section class="main-wrapper-contants">
                ...
                <div class="d-flex justify-content-center align-items-center gap-2">
                        ...
                        <h3 class="title-header mb-0">Lojas</h3>
                    </div>
                    <a href="<?php echo $url;?>lojas/cadastrar/<?php echo $_GET['id']?>">
    ...
    <script src="<?php echo $url; ?>/js/lojas/list.js<?php echo $jsVersion;?>"></script>
