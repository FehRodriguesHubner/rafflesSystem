...
<head>
    ...
    <title>Criar Congresso - CUT</title>
...
<body>
                ...
                <div class="card-profile form-wrapper">
                    <header class="d-flex p-4 pb-2 flex-column">
                        <div class="back-to d-flex align-items-center">
                            ...
                            &nbsp;
                            <span class="card-container-title">Cadastrar Congresso</span>
                        </div>
                    </header>
                                        
                    <form id="form-category" class="mt-3">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-group">
                                            <label for="name">Nome do congresso</label>
                                            <div class="placeholder-input w-100">
                                                <div class="input-container">
                                                    <input id="name" type="text" class="input-default" readonly="">
                                    ...
                                    <div class="col-12">
                                        <div class="input-group">
                                            ...
                                            <div class="placeholder-input w-100">
                                                <div class="input-container">
                                                    <input id="description" type="text" class="input-default" readonly="">
                                                    <small class="input-message"></small>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script src="<?php echo $url;?>/js/contents/categories/create.js"></script>
