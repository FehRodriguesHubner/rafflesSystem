...
<body>
                ...
                <form id="form-message" class="card-profile form-wrapper">
                    <header class="d-flex p-4 pb-2 flex-column">
                        <div class="back-to d-flex align-items-center">
                            ...
                            &nbsp;
                            <span class="card-container-title">Efetuar Disparo</span>
                        </div>
                    </header>
                    ...
                    <div class="mt-3">
                        <div class="wrapper-infos-form">
                            <section class="p-3 pt-md-0 pt-0 p-md-4">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="input-group">
                                            <label for="name">Número de destino</label>
                                            <div class="placeholder-input w-100">
                                                <div class="input-container">
                                                    <input placeholder="Ex.: 51 98888-8888 | 51988888888 | +1408XXXXXXX (internacional)" id="telefone" name="telefone" type="text" class="input-default"></textarea>
                                                    <small class="input-message"></small>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <footer class="d-flex justify-content-between p-3 p-md-4">
                            ...
                            <button type="submit" class="button-default bg-blue color-white">Enviar</button>
                        </footer>
                    </div>
                </form>
            </section>
    ...
    <script src="<?php echo $url; ?>/js/servicos/disparos/disparo-unico.js"></script>
