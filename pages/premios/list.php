...
<body>
            ...
            <section class="main-wrapper-contants">
                ...
                <header class="d-flex justify-content-between align-items-center mb-2 mb-md-4">
                    <div class="d-flex justify-content-center align-items-center gap-2">
                        ...
                        <h3 class="title-header mb-0">Prêmios</h3>
                    </div>
                    <a href="<?php echo $url;?>premios/cadastrar/<?php echo $_GET['id']?>">
    ...
    <script src="<?php echo $url; ?>/js/premios/list.js<?php echo $jsVersion;?>"></script>
