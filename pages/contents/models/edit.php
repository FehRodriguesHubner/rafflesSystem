...
<body>
                ...
                <div class="card-profile form-wrapper">
                    <header class="d-flex p-4 pb-2 flex-column">
                        <div class="back-to d-flex align-items-center">
                            ...
                            &nbsp;
                            <span class="card-container-title">Editar Cadastro</span>
                        </div>
                    </header>
                                        
                    <form autocomplete="off" id="form-model" class="mt-3">
                        <input autocomplete="off" type="hidden" value="<?php echo $_GET['id'];?>" name="id" id="id"/>
    ...
    <script src="<?php echo $url;?>/js/contents/models/edit.js"></script>
