...
<body>
                ...
                <div class="card-profile form-wrapper">
                    <header class="d-flex p-4 pb-2 flex-column">
                        <div class="back-to d-flex align-items-center">
                            ...
                            &nbsp;
                            <span class="card-container-title">Editar Congresso</span>
                        </div>
                    </header>
                                        
                    <form id="form-category" class="mt-3">
                        <input type="hidden" id="id-category" name="id" value="<?php echo $_GET['id'];?>">
    ...
    <script src="<?php echo $url;?>/js/contents/categories/edit.js"></script>
